...
const ROOM_STYLES = [
  {
    ...
    items: 38,
    value: 2840,
    recentItem: "Sony WH-1000XM5 Headphones",
    missingInfo: false,
    Icon: Bed,
    iconBg: "bg-pink-50",
  ...
  },
  {
    ...
    items: 41,
    value: 1960,
    recentItem: "Power Drill — DeWalt 20V",
    missingInfo: true,
    Icon: Car,
    iconBg: "bg-amber-50",
  ...
  },
  {
    ...
    items: 45,
    value: 2380,
    recentItem: "Ninja Air Fryer 5.5qt",
    missingInfo: false,
    Icon: Coffee,
    iconBg: "bg-orange-50",
  ...
  },
  {
    ...
    items: 52,
    value: 5200,
    recentItem: "Bookshelf Speakers (Pair)",
    missingInfo: false,
    Icon: Sofa,
    iconBg: "bg-violet-50",
  ...
  },
  {
    ...
    items: 12,
    value: 890,
    recentItem: "Winter Jacket — North Face",
    missingInfo: true,
    Icon: Shirt,
  ...
  },
  {
    ...
    items: 18,
    value: 420,
    recentItem: "AA Batteries (Bulk Pack)",
    missingInfo: false,
    Icon: Wrench,
    iconBg: "bg-slate-50",
  ...
  },
  {
    ...
    items: 8,
    value: 610,
    recentItem: "Vacuum Cleaner — Dyson V11",
    missingInfo: false,
    Icon: Archive,
    iconBg: "bg-teal-50",
...
export default function RoomsPage({ onSignOut, onNavigate, onSettings }: RoomsPageProps) {
  ...
  const rooms = (roomsQuery.data ?? []).map((room, index): Room => ({
    ...
    value: room.estimatedValue,
    recentItem: room.recentItem || "No items yet",
    missingInfo: room.missingInfo,
  }));
  ...
  const mostUsed = rooms.reduce<Room | null>(
    (top, room) => (!top || room.items > top.items ? room : top),
    null,
  );
      ...
      <main className="max-w-[1440px] mx-auto px-8 py-7 space-y-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            },
            {
              label: "Most Items",
              value: mostUsed?.name ?? "—",
              sub: mostUsed ? `${mostUsed.items} items` : "No data",
              Icon: TrendingUp,
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-4 px-3 py-2 rounded-lg bg-muted/60">
                    ...
                    <p className="text-xs text-foreground font-semibold leading-snug line-clamp-1">
                      {room.recentItem}
                    </p>
                  </div>
            ...
            <div className="space-y-4">
              <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-muted-foreground mb-4">
                    {detail.items} items · ${detail.value.toLocaleString()} est. value
                  </p>
                  ...
                  <div className="space-y-2">
                    <button
                      onClick={() => onNavigate("roomDetail", detail.id)}
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 h-9 rounded-xl border border-red-200 bg-red-50 text-sm font-semibold text-red-600 hover:bg-red-100 transition-colors"
                    >
                      <Trash2 size={13} />
                      Delete Room
                    </button>
              ...
              <div className="bg-card rounded-2xl border border-border shadow-sm p-5">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${detail.iconBg}`}
                  >
        ...
        {(error || roomsQuery.error) && (
          <div className="fixed bottom-5 right-5 z-50 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700">
            {error ??
              (roomsQuery.error instanceof Error ? roomsQuery.error.message : "Unable to load rooms.")}
          </div>
        )}
        {deleteTarget && (
          <div
          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                This room will be removed from your account. Items currently assigned to it will not be
                deleted; their room will be cleared and shown as unassigned.
              </p>
