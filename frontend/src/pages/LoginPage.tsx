...
import { Eye, EyeOff, AlertCircle, Loader2, Layers, Package, Map, ShieldCheck, Sparkles } from "lucide-react";
...
export default function LoginPage({ onSuccess, onCreateAccount }: LoginPageProps) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(
        requestError instanceof Error ? requestError.message : "We couldn't sign you in. Please try again.",
      );
    } finally {
      setLoading(false);
    }
  ...
  const features = [
    ...
    {
      Icon: ShieldCheck,
      label: "Insurance-ready records",
      desc: "Estimated values and receipts in one place.",
    },
  ];
        ...
        <div className="relative z-10 flex flex-col h-full p-10 xl:p-12">
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <p className="text-sm text-white/50 italic leading-relaxed">
              "HomeVault helped me catalog 300+ items in an afternoon. Best thing I did before our home
              insurance renewal."
            </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-muted-foreground">Sign in to manage your home inventory.</p>
          </div>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
              ...
              />
              <path
                d="M9 3.5795C10.3214 3.5795 11.5077 4.0336 12.4405 4.9259L15.0218 2.3445C13.4632 0.8918 11.4259 0 9 0C5.48182 0 2.43818 2.0168 0.957275 4.9582L3.96409 7.29C4.67182 5.1627 6.65591 3.5795 9 3.5795Z"
                fill="#EA4335"
              />
            </svg>
